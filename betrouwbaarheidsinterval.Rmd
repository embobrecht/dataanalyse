...
betrouwjehet = function(aantalloops,grootte,data){
  ...
  steekproef = sample(data,grootte)
      ...
      minimum = mu-(qnorm(0.875)*(si/sqrt(grootte)))
      maximum = mu+(qnorm(0.875)*(si/sqrt(grootte)))
...
print(betrouwjehet(100000,64,narmdata))

resultaatvector=c()
loopVector = c(1,10,100,500,1000,5000,10000,100000)
